...
struct RPCCallTestData
{
    ...
    RPCCallTestData(
        ...
        char const* exp_)
        : description(description_), line(line_), args(args_), exp(1, exp_)
    {
    }
    ...
    RPCCallTestData(
        ...
        : description(description_), line(line_), args(args_), exp(exp_)
    {
    }
...
static RPCCallTestData const rpcCallTestArray[] = {
   ...
   "params" : [
    ...
    },
    {
        ...
        __LINE__,
        {"account_tx", "rHb9CJAWyB4rj91VRWn96DkukG4bwdtyTh", "-1", "-1", "200", "bad_offset"},
        R"({
   "method" : "account_tx",
   "params" : [
      {
    ...
    },
    {
        ...
        __LINE__,
        {"account_tx", "rHb9CJAWyB4rj91VRWn96DkukG4bwdtyTh", "-1", "-1", "bad_limit"},
        R"({
   "method" : "account_tx",
   "params" : [
      {
