    ...
    result &= [&]() {
        switch (txnType)
        {
            ...
            case ttVAULT_DEPOSIT: {
                ...
                {
                    JLOG(j.fatal()) <<  //
                        "Invariant failed: deposit assets outstanding must not exceed assets "
                        "maximum";
                    result = false;
                }
            ...
            case ttVAULT_WITHDRAW: {
                ...
                if (!issuerWithdrawal)
                {
                    ...
                    {
                        JLOG(j.fatal()) <<  //
                            "Invariant failed: withdrawal must change vault and destination "
                            "balance by equal amount";
                        result = false;
                    }
                }
                ...
                {
                    JLOG(j.fatal()) <<  //
                        "Invariant failed: withdrawal must change depositor and vault shares by "
                        "equal amount";
                    result = false;
                }
